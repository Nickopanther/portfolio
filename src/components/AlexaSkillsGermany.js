...
const AlexaSkillsGermany = () => {
   ...
   <div className="container content">
      ...
      <p>Eine Liste der vielen Alexa-Fähigkeiten, die ich erstellt habe und die verwendet werden können
      auf jedem Alexa-Gerät. Klicken Sie auf ein Bild oder einen Namen, um mehr über eine Fertigkeit zu erfahren.</p>
