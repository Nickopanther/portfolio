...
const AlexaSkillsAustralia = () => {
    return (
        <div className="AlexaSkillsAustralia">
   <div className="container content">
      <Helmet>
         <title>Alexa Skills in Australia - Nick Azzarello</title>
      ...
      <h1 className="center title">Alexa Skills in Australia</h1>
      ...
      <div className="row one">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Catholic-Prayers/dp/B0787HK4FN/ref=sr_1_1?dchild=1&keywords=catholic+prayers&qid=1597333625&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Ring-Doorbell/dp/B07MCSVRX2/ref=sr_1_2?dchild=1&keywords=ring+doorbell&qid=1597333739&s=digital-skills&sr=1-2" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Wake-Up/dp/B077PML4M8/ref=sr_1_5?dchild=1&keywords=wake+up&qid=1597333818&s=digital-skills&sr=1-5" target="_blank" rel="noopener noreferrer">
               <img src={WakeUpSkill}
                  height="210"
                  width="210"
                  alt="Wake Up"
      ...
      <div className="row two">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Eagles-Chant/dp/B082X9JVQN/ref=sr_1_1?dchild=1&keywords=eagles+chant&qid=1597333940&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Most-Famous-Princess-Bride-Quote/dp/B07KDQDDSK/ref=sr_1_1?dchild=1&keywords=most+famous+princess+bride&qid=1597334215&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Titanic-vs-Titan-Facts/dp/B078PWMV84/ref=sr_1_5?dchild=1&keywords=titanic&qid=1597334271&s=digital-skills&sr=1-5" target="_blank" rel="noopener noreferrer">
      ...
      <div className="row three">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Cleanup-Game/dp/B07BV3FDJD/ref=sr_1_2?dchild=1&keywords=clean+up+game&qid=1597334370&s=digital-skills&sr=1-2" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Christmas-Guitar/dp/B087R641LM/ref=sr_1_1?dchild=1&keywords=christmas+guitar&qid=1597334738&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Italy-Sights/dp/B088WDCFWR/ref=sr_1_1?dchild=1&keywords=italy+sights&qid=1597334816&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
      ...
      <div className="row four">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Hamlet-Quotes/dp/B0846GKT74/ref=sr_1_1?dchild=1&keywords=hamlet+quotes&qid=1597335123&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Romeo-and-Juliet-Quotes/dp/B084LFJCRB/ref=sr_1_1?dchild=1&keywords=romeo+and+juliet+quotes&qid=1597335199&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Camping-Trip/dp/B07D9XPJHX/ref=sr_1_1?dchild=1&keywords=let%27s+go+camping&qid=1597335338&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
      ...
      <div className="row five">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Elephant-Sounds/dp/B08413QSY7/ref=sr_1_2?dchild=1&keywords=elephant+sounds&qid=1597335402&s=digital-skills&sr=1-2" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Cow-Sounds/dp/B084TSCMTY/ref=sr_1_1?dchild=1&keywords=cow+sounds&qid=1597335533&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Staples-Easy-Button/dp/B07GDCJ526/ref=sr_1_1?dchild=1&keywords=easy+button&qid=1597335598&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
      ...
      <div className="row six">
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Burp-Sounds/dp/B089ZVRH6R/ref=sr_1_1?dchild=1&keywords=burp+sounds&qid=1597335655&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
         ...
         <div className="alexa col s12 m4 l4">
            <div className="alexa-image">
               <a href="https://www.amazon.com.au/Nickopanther-Deer-Sounds/dp/B08FHT25L5/ref=sr_1_1?dchild=1&keywords=deer+sounds&qid=1597335714&s=digital-skills&sr=1-1" target="_blank" rel="noopener noreferrer">
      ...
      <div className="container">
        ...
        <p>If you live outside of Australia and are interested in one of my
...
export default AlexaSkillsAustralia;
