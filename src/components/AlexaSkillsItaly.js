...
const AlexaSkillsItaly = () => {
   ...
   <div className="container content">
      ...
      <p>Un elenco delle molte abilità di Alexa che ho creato che sono disponibili per l'uso
      su qualsiasi dispositivo Alexa. Fare clic su un'immagine o su un nome per saperne di più su un'abilità.</p>
